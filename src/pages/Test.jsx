...
import { findPredict } from "../../slices/predictSlice";
function Test() {
      ...
      <Form method="POST">
        <div className=" max-w-[100%] w-[300px] h-[600px] bg-[#153448] rounded-md m-auto sm:w-[900px] p-2 sm:p-5 space-y-3 overflow-y-auto mt-8">
          ...
          <div className="flex items-center gap-5">
            <label htmlFor="hyperTension">Do you have hyper Tension ? </label>
            <input
              id="hyperTension"
              name="hyperTension"
              className="w-[20px] h-[20px] accent-[#3C5B6F] focus:ring focus:ring-offset-1 focus: ring-[#3C5B6F] "
              type="checkbox"
              value={hyperTension}
...
export async function action({ request }) {
  ...
  console.log(result);
  store.dispatch(findPredict(result.prediction));

  return redirect("/stroke_clinic/");
}

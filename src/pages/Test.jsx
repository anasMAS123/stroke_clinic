...
function Test() {
  ...
  return (
    <div className="bg-[#3C5B6F] text-center text-white ">
      ...
      {isLoading ? (
        <div className=" max-w-[100%] w-[300px] h-[600px] bg-[#153448] rounded-md m-auto sm:w-[900px] p-2 sm:p-5 space-y-3 overflow-y-auto mt-8 flex justify-center items-center">
          <Audio
            height="120"
            width="120"
            radius="9"
